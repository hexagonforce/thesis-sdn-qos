...
echo $aboutputfile > aboutput.log
...
sudo -u ubuntu ab -l -r -n 50000 -c 10 -k -t $1 -s 240 -q -H "Accept-Encoding: gzip, deflate" http://10.0.1.105/100MB.bin > $aboutputdir/$aboutputfile &
